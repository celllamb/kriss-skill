...
범용 스킬의 경우 그 자체로도 활용이 있고 KRISS 스킬중 일부는 그러한 범용 스킬들을 활용하는 것도 있으니 같이 넣어주는 것도 좋습니다.
...
다른 유형도 작동은 할텐데 테스트를 해보지는 않았습니다. 다른 유형은 제가 학회나 파견연구를 가게되면 테스트하게 될 것 같네요. :blush:
