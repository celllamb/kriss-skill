...
설치, 실행, 설정 방법뿐 아니라 보고서, 계획서, 제안서, 발표자료를 작성할 때도 공식 문서를 먼저 확인하도록 하는 범용 스킬입니다. 소프트웨어 설치 명령, 제품 기능, 지원 범위, 정책, 표준, 프로그램 공고는 버전이나 날짜에 따라 바뀔 수 있으므로 기억에 의존한 답변을 줄이는 데 유용합니다.
...
- 기술 보고서나 계획서에서 제품 기능, 제약, 지원 범위, 표준, 정책을 설명할 때
- 발표자료에서 벤더 문서, 공식 white paper, 표준 문서, 프로그램 안내를 근거로 기능이나 요구사항을 요약할 때
...
Use $official-docs-setup. 이 계획서의 기술 설명과 요구사항을 공식 문서 기준으로 검토해줘.
Use $official-docs-setup. 이 발표자료에 들어갈 제품 기능 요약을 공식 문서 출처와 함께 작성해줘.
```
